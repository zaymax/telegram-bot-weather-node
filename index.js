...
let dailyForecast = 'http://dataservice.accuweather.com/forecasts/v1/daily/1day/{city}';
...
bot.on('message',function(msg, match){
    ...
    switch(msg.text) {
        ...
        case keyboard_buttons.home.weather_now:
            ...
            //     }
            // });
            var maintenance = 'Уважаемый ' + msg.from.first_name + ', данная функция находится в разработке.';
            ...
            bot.sendMessage (chatId, 'В какое время вам отправлять прогноз погоды на сегодня?');
            break
            ...
            case keyboard_buttons.settings.location:
                // bot.sendMessage(chatId, 'Пожалуйста, отправьте или напишите нам ваше местомположение для того, чтобы мы могли правильно отправлять погоду для вас.', {
                //     reply_markup: {
                //         inline_keyboard: [
                //             [
                //                 {
                ...
                inline_keyboard: [
                    [{text: 'Location', callback_data: 'whatever', request_location: true}],
                    [{text: 'Contact', callback_data: 'whatever', request_contact: true}],
                ],
                resize_keyboard: true,
                one_time_keyboard: true,
                }),
